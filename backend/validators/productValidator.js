...
const createProductValidation = [
    ...
    body('stock')
        .optional()
        .isInt({ min: 0 })
        .withMessage('Ilość ogółem musi być liczbą całkowitą nieujemną'),
    body('warehouses')
        .optional()
        .isObject()
        .withMessage('Magazyny muszą być obiektem'),
    body('warehouses.HSN')
        .optional()
        .isInt({ min: 0 })
        .withMessage('HSN musi być liczbą całkowitą nieujemną'),
    body('warehouses.HZA')
        .optional()
        .isInt({ min: 0 })
        .withMessage('HZA musi być liczbą całkowitą nieujemną'),
    body('warehouses.SZC')
        .optional()
        .isInt({ min: 0 })
        .withMessage('SZC musi być liczbą całkowitą nieujemną')
];
